<?php
session_start();
if (!isset($_SESSION['id_manager']) || $_SESSION['role'] !== "Manager") {
...
<div class="main" style="margin-left:250px; padding:20px; font-family:Arial, sans-serif;">
    ...
    <h2>Selamat Datang, <?= $_SESSION['nama_manager']; ?> 👋</h2>
    <p>Anda login sebagai <b>Manager</b>.</p>
    ...
    <footer style="margin-top:40px; font-size:12px; color:#777;">
        &copy; <?= date("Y"); ?> Koperasi Fahri - Dashboard Manager
    </footer>
</div>
