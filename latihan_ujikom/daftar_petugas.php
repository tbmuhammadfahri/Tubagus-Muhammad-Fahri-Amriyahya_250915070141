...
if (isset($_POST['register'])) {
    ...
    if (mysqli_num_rows($cek) > 0) {
        ...
        $query = "INSERT INTO petugas (nama_user, username, password, id_level) 
...
// Ambil data level untuk pilihan dropdown
...
<body>
    <div class="box">
        ...
        <a href="login_petugas.php" class="btn-back">← Kembali ke Login</a>
    </div>
</body>
</html>
